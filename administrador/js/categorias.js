...
function agregar_subcategoria() {
    ...
    if(categoria.nombre && $("#subcategoria").val()){
...
function start() {
    var btn_agregar_subcategoria, btn_agregar_subsubcategoria, btn_guardar_categoria, btn_eliminar_categoria;
    ...
    btn_eliminar_categoria = $("#eliminar_categoria");
    ...
    btn_eliminar_categoria.click(function(){
        borrar_tabla($("#tabla_categorias tbody"));
        eliminar_categoria();
    });
}
