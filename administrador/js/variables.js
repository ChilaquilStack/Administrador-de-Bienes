...
var url = "http://transparencia-financiera.app.jalisco.gob.mx/administrador/", 
    bienes = [] ,tabla_creditos, tabla_articulos, credito_fiscal = {
    "contribuyente": {
        "domicilio": {}
    },
    "bien": {
...
columnas_articulos = [
    ...
    },
    {
        ...
        "data": "numero_control",
        "render": function(data,type, row) {
        var direccion = url + "creditos/" + data + "/imagenes";
...
columnas_creditos_contribuyente = [
    ...
    },
    {
        ...
        "titleAttr": "Agregar Bién",
        "render": function(data){
            var direccion = url + "creditos/" + data + "/add";
            return "<a href='" + direccion + "' target='_blank><button type='button' class='btn btn-primary btn-sm''><i id='add_credito' class='fa fa-plus' aria-hidden='true'></i></button></a>";
        }
    }
],
