...
CREATE UNIQUE INDEX `correo_UNIQUE` ON `mydb`.`usuarios` (`correo` ASC);
...
-- Table `mydb`.`remate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`remate` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE UNIQUE INDEX `id_UNIQUE` ON `mydb`.`remate` (`id` ASC);
...
-- -----------------------------------------------------
-- Table `mydb`.`articulos_subcategorias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`articulos_subcategorias` (
  `articulos_id` INT NOT NULL,
  `subcategorias_id` INT NOT NULL,
  CONSTRAINT `fk_articulos_has_subcategorias_articulos1`
    FOREIGN KEY (`articulos_id`)
    REFERENCES `mydb`.`articulos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_articulos_has_subcategorias_subcategorias1`
...
CREATE INDEX `fk_articulos_has_subcategorias_subcategorias1_idx` ON `mydb`.`articulos_subcategorias` (`subcategorias_id` ASC);

CREATE INDEX `fk_articulos_has_subcategorias_articulos1_idx` ON `mydb`.`articulos_subcategorias` (`articulos_id` ASC);
...
CREATE TABLE IF NOT EXISTS `mydb`.`lotes` (
  `articulos_id` INT NOT NULL,
  `remate_id` INT NOT NULL,
  CONSTRAINT `fk_articulos_has_remates_articulos`
    FOREIGN KEY (`articulos_id`)
    REFERENCES `mydb`.`articulos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_lotes_remate`
    FOREIGN KEY (`remate_id`)
    REFERENCES `mydb`.`remate` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
