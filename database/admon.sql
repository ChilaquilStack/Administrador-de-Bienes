...
CREATE TABLE IF NOT EXISTS `mydb`.`postores` (
  ...
  CONSTRAINT `fk_postores_domicilios1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_postores_domicilios2`
    FOREIGN KEY (`domicilios_id1`)
    REFERENCES `mydb`.`domicilios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_postores_domicilios2_idx` ON `mydb`.`postores` (`domicilios_id1` ASC);
...
CREATE TABLE IF NOT EXISTS `mydb`.`pujas` (
  ...
  CONSTRAINT `fk_Pujas_articulos1`
    FOREIGN KEY (`articulos_id`)
    REFERENCES `mydb`.`articulos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Pujas_postores1`
...
CREATE INDEX `fk_Pujas_articulos1_idx` ON `mydb`.`pujas` (`articulos_id` ASC);
