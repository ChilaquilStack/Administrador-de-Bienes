...
CREATE INDEX `fk_bienes_depositarios_idx` ON `administrador`.`bienes` (`depositarios_id` ASC);

CREATE INDEX `fk_bienes_domicilios_idx` ON `administrador`.`bienes` (`deposito_id` ASC);
...
-- -----------------------------------------------------
-- Table `administrador`.`articulos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `administrador`.`articulos` (
...
CREATE INDEX `fk_articulos_bienes1_idx` ON `administrador`.`articulos` (`bienes_numero_control` ASC);
...
CREATE TABLE IF NOT EXISTS `administrador`.`imagenes` (
  ...
  CONSTRAINT `fk_imagenes_articulos1`
    ...
    REFERENCES `administrador`.`articulos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_imagenes_articulos1_idx` ON `administrador`.`imagenes` (`articulos_id` ASC);
...
CREATE INDEX `fk_Creditos_Fiscales_has_bienes_bienes1_idx` ON `administrador`.`embargos` (`bienes_numero_control` ASC);
...
-- -----------------------------------------------------
-- Table `administrador`.`articulos_categorias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `administrador`.`articulos_categorias` (
  `articulos_id` VARCHAR(45) NOT NULL,
  `categorias_id` INT NOT NULL,
...
CREATE INDEX `fk_articulos_has_categorias_categorias1_idx` ON `administrador`.`articulos_categorias` (`categorias_id` ASC);

CREATE INDEX `fk_articulos_categorias_articulos1_idx` ON `administrador`.`articulos_categorias` (`articulos_id` ASC);
...
CREATE INDEX `fk_valuaciones_articulos1_idx` ON `administrador`.`valuaciones` (`articulos_id` ASC);
...
-- -----------------------------------------------------
-- Table `administrador`.`motivos_bajas_articulos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `administrador`.`motivos_bajas_articulos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `descripcion` VARCHAR(100) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `administrador`.`bajas_articulos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `administrador`.`bajas_articulos` (
  ...
  CONSTRAINT `fk_articulos_has_motivos_bajas_articulos_motivos_bajas_articu1`
    ...
    REFERENCES `administrador`.`motivos_bajas_articulos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_articulos_has_motivos_bajas_articulos_motivos_bajas_arti_idx` ON `administrador`.`bajas_articulos` (`motivos_bajas_articulos_id` ASC);

CREATE INDEX `fk_bajas_articulos_usuarios1_idx` ON `administrador`.`bajas_articulos` (`usuarios_id` ASC);
...
CREATE INDEX `fk_lotes_articulos1_idx` ON `administrador`.`lotes` (`articulos_id` ASC);
