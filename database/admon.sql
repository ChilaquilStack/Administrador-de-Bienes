...
CREATE TABLE IF NOT EXISTS `administrador`.`contribuyentes` (
  ...
  `rfc` VARCHAR(45) NULL DEFAULT NULL COMMENT 'En caso de que cuente con CURP y RFC',
...
CREATE INDEX `fk_bienes_domicilios1_idx` ON `administrador`.`bienes` (`depositos_id` ASC);
