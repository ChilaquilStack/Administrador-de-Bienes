...
CREATE TABLE IF NOT EXISTS `mydb`.`domicilios` (
  ...
  CONSTRAINT `fk_domicilios_municipios1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_domicilios_postores1`
...
CREATE INDEX `fk_domicilios_postores1_idx` ON `mydb`.`domicilios` (`postores_RFC` ASC);
...
CREATE TABLE IF NOT EXISTS `mydb`.`bajas_articulos` (
  ...
  `articulos_id` INT NOT NULL,
  `usuarios_id` INT NOT NULL,
  PRIMARY KEY (`motivos_bajas_articulos_id`, `usuarios_id`),
